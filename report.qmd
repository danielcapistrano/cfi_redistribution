---
title: "Public support for income redistribution and welfare policies in Ireland"
format:
   docx:
     toc: false
     link-citations: true
...
This report is based on a research project that investigated public support for income redistribution and welfare policies in Ireland. The main questions that guided the research were the following:
- Has the support for income redistribution changed over time?  
- What are the main attitudes and beliefs in relation to welfare policies?  
- What individual and contextual factors are associated with support for redistribution and
