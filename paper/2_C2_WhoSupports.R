...
save_output(fig_c2_eumap, w = 6, h = 5)
...
save_output(fig_c2_sex, w=6, h=5)
...
save_output(fig_c2_age_eu, w=6, h=5)
...
save_output(fig_c2_class, w = 6, h= 6)
