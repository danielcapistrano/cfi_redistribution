...
### Add flag if interview was conducted before DSP campaign
Add 
...
ess_ie <- 
    ess_ie |> 
        mutate(dsp_before = if_else(ess_day < as.Date(dsp_day), 1, 0)) |> 
        mutate(dsp_diffdays = ess_day - as.Date(dsp_before)) 
